...
function contact_map_shortcode() {
    ...
    $retour .= 'icon: \''.get_template_directory_uri() . '/images/custom_pin.png\'';
    $retour .= '});';
...
function contact_iconset_shortcode($atts) {
    ...
    $retour .= '<img class="alignnone size-full wp-image-37" src="'.get_template_directory_uri() . '/images/pin.png" alt="pin" width="128" height="128" />';
    $retour .= '<h4>ADRESSE</h4>';
    $retour .= $atts['adress'];//'6 Rue Paul Bert, 38000 Grenoble';
    $retour .= '</div>';
    $retour .= '<div class="col-md-4 col-sm-4 text-center">';
    $retour .= '<img class="alignnone size-full wp-image-36" src="'.get_template_directory_uri() . '/images/phone.png" alt="phone" width="128" height="128" />';
    $retour .= '<h4>TELEPHONE</h4>';
    $retour .= $atts['phone'];
    $retour .= '</div>';
    $retour .= '<div class="col-md-4 col-sm-4 text-center">';
    $retour .= '<img class="alignnone size-full wp-image-39" src="'.get_template_directory_uri() . '/images/mail.png" alt="mail" width="128" height="128" />';
    $retour .= '<h4>MAIL</h4>';
    $retour .= $atts['mail'];
    $retour .= '</div>';
    $retour .= '</div>';
